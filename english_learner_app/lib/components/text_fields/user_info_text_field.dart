...
class UserInfoTextField extends StatelessWidget {
  ...
  get decoration => InputDecoration(
        errorStyle: ConstTextStyles.description.setUp.copyWith(color: CustomColor.rossoCorsa.get),
        ...
        prefixIcon: Icon(SuperVisor.shared.binaryCondition(condition: typeKey == UserInfoTextFieldKey.email, convenient: Icons.email, inconvenient: FontAwesomeIcons.key), color: CustomColor.deepRacingGreen.get),
        hintStyle: ConstTextStyles.description.setUp.copyWith(color: CustomColor.deepRacingGreen.get),
        filled: true,
        contentPadding: EdgeInsets.zero,
        fillColor: CustomColor.athensGray.get,
