...
class ProfileCard extends StatelessWidget {
  ...
  get _profileImage => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(width: 5, color: CustomColor.athensGray.apply),
  ...
  get _profileInfo => Column(
        ...
        children: [
          Row(
            children: [
              Text(ConstTexts.intance.goodDay.toUpperCase(), style: ConstTextStyles.content.apply),
              Icon(FontAwesomeIcons.handHoldingHeart, color: CustomColor.athensGray.apply, size: 16),
            ],
          ),
          Text(emailOrUsername ?? ConstTexts.intance.none, style: ConstTextStyles.content.apply.copyWith(fontSize: 20)),
        ],
      );
}
