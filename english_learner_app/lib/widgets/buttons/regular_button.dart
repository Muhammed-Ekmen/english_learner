...
class RegularButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Directionality(
          ...
          child: ElevatedButton.icon(
            icon: SuperVisor.shared.nullable(willCheck: icon, nil: const SizedBox.shrink(), notNil: Icon(icon, color: foregroundColor ?? CustomColor.deepRacingGreen.apply)),
            style: _buttonStyle,
            onPressed: onTap,
            label: FittedBox(child: Text(title ?? ConstTexts.intance.none, style: ConstTextStyles.content.apply.copyWith(color: foregroundColor ?? CustomColor.deepRacingGreen.apply))),
          ),
        ),
      );
  ...
  ButtonStyle get _buttonStyle => ButtonStyle(
        ...
        shadowColor: MaterialStateProperty.all(CustomColor.athensGray.apply),
        backgroundColor: MaterialStateProperty.resolveWith((states) => states == MaterialState.pressed ? CustomColor.rossoCorsa.apply : backGorundColor ?? CustomColor.athensGray.apply),
      );
}
